...
function Footer() {
  return (
    <div  className='w-full overflow-hidden  relative h-[100vh] py-24 px-14'>
        <div className='inner flex gap-[10vw]'>
        <div className='Eye-Opening font-["Founders_Grotesk"] flex flex-col justify-between w-[38%] h-full'>
            <div className='heading'>
                <h1 className='uppercase text-[6.4vw] font-semibold leading-none tracking-tighter py-6 '>EYE- <br />Opening</h1>
            </div>
            
        </div>
        <div className='Presentation w-[65%]'>
            <h1 className='uppercase text-[6vw] px-2 font-semibold font-["Founders_Grotesk"] '>Presentations</h1>
            <div className='details px-3 mt-2 text-[1.2vw]'>S:
                <a className='block mt-3  underline' href="https://www.instagram.com/ochi_design/">Instagram</a>
                <a className= 'block mt-1 underline' href="https://www.facebook.com/people/OCHI-presentation-design/100067218942460/">Facebook</a>
                <a className= 'block mt-1 underline' href="https://www.linkedin.com/authwall?trk=bf&trkInfo=AQFSdLHWArjFDgAAAZDOt_Yod0U94hM4JsRx-3a2IurJaCuhDK6HlW3gY3A1nqtc-yUsQOLVTATUmQz9UuB72o0Q0Bm3SwMuNfJViy_I1wE_95QuwmRVaNkGRNEovcp5pueX-UU=&original_referer=https://ochi.design/&sessionRedirect=https%3A%2F%2Fwww.linkedin.com%2Fcompany%2F56403597">LinkedIn</a>
                <a className='block  mt-1 underline' href="https://www.behance.net/ochi_design">Behance</a>
            </div>
            <div className='details text-[1.2vw] mt-8 px-3'>L:
            <a className='block mt-3  underline' href="#">202-1965 W 4th Ave <br />Vancouver, Canada</a>
            <a className='block mt-6  underline' href="#">30 Chukarina St <br />Lviv, Ukraine</a>
            </div>
            <div className='email text-[1.2vw] mt-12 px-3'>E:
            <a className='block mt-3 underline' href="#">hello@ochi.design</a>
            </div>
    
            
        </div>
        </div>
        <div className='outer w-full flex items-center justify-between h-[8vh] mt-[7vw]'>
            ...
            <div className='center-copy text-[#B2B3B3]'>
                <h2>© design 2024.</h2>
            </div>
            <div className='right-web text-[#B2B3B3]'>
